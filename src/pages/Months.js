                ...
                <Route path={`${match.path}`}>
                    ...
                    <div className="flex flex-col p-8 w-screen">
                        <div className="flex row flex-wrap items-center md:items-start">
                            {arr.map(i => {
                                return (
                                    <Link className="w-[120px]  py-2 px-4 bg-transparent mr-2 mt-2 text-cyan-600 font-semibold border border-cyan-600 rounded hover:bg-cyan-600 hover:text-white hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0 "
                                        to={`${match.url}/${i.id}`}
                                    >
                                        Tháng {i.id}
                                    </Link>
