  ...
  return (
    <div className="bg-[#dd6612] h-screen w-screen flex flex-col items-center ">
      <div className="my-auto flex flex-col items-center ">
        ...
        <p className="sm:text-sm font-normal sm:mt-[32px] sm:w-[360px] mt-[24px] w-[264px] text-[12px] text-white text-center"> If you have cardboard boxes, aluminum cans or (unused) plastic bottles you want to sell, please contact us +84 8 2525 1567</p>
